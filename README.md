...
When run in this mode, the script will execute all its internal logic but will only output the exact adduser and passwd commands that would have been run, allowing the user to check for errors before committing the changes.
